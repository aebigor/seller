        ...
        <div class="row">
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <input name="user_name" type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="cliente_nombre_reg" id="cliente_nombre" maxlength="40">
            </div>
          </div>
          ...
          <div class="col-12 col-md-4">
            <div class="form-group">
              ...
              <input name="user_lastname" type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="cliente_apellido_reg" id="cliente_apellido" maxlength="40">
            </div>
          </div>
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <input name="user_doc" type="text" pattern="[0-9-]{1,27}" class="form-control" name="cliente_dni_reg" id="cliente_dni" maxlength="27">
            </div>
          </div>
          ...
          <div class="col-12 col-md-4">
            <div class="form-group">
              ...
              <input name="user_cel" type="text" pattern="[0-9()+]{8,20}" class="form-control" name="cliente_telefono_reg" id="cliente_telefono" maxlength="20">
            </div>
          </div>
          ...
          <div class="col-12 col-md-4">
            <div class="form-group">
              ...
              <input name="user_email" type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,150}" class="form-control" name="cliente_direccion_reg" id="cliente_direccion" maxlength="150">
            </div>
          </div>
          ...
          <div class="col-12 col-md-4">
            <div class="form-group">
              ...
              <input name="user_pass" type="password" class="form-control" name="cliente_contraseña_reg" id="cliente_contraseña" maxlength="150">
            </div>
          </div>
          ...
          <div class="col-12 col-md-4">
            <div class="form-group">
              ...
              <select class="form-control" name="user_rol_reg" id="cliente_rol">
