...
<html lang="en" data-bs-theme="auto">
  <head><script src="assets/plantilla/bootstrap_5.3.3/assets/js/color-modes.js"></script>
    ...
    <style>
      ...
      --bs-btn-font-weight: 600;
      --bs-btn-color: var(--bs-white);
      --bs-btn-bg: var(--bd-orange-bg); /* Color base */
      --bs-btn-border-color: var(--bd-orange-bg);
      --bs-btn-hover-color: var(--bs-white);
      --bs-btn-hover-bg: #f64d00; /* Un tono más oscuro de naranja para el hover */
      --bs-btn-hover-border-color: #f64d00; /* Borde del hover */
      --bs-btn-focus-shadow-rgb: var(--bd-orange-rgb);
      --bs-btn-active-color: var(--bs-btn-hover-color);
      --bs-btn-active-bg: #e64a00; /* Un color aún más oscuro para el estado activo */
      --bs-btn-active-border-color: #e64a00;

      background: linear-gradient(45deg, #fe6902, #f64d00); /* Degradado de naranja */
      border: 2px solid #fe6902;
    }

    .btn-bd-primary:hover {
      background: linear-gradient(45deg, #f64d00, #fe6902); /* Degradado invertido para el hover */
      border-color: #f64d00;
    }

    .btn-bd-primary:active {
      background: linear-gradient(45deg, #e64a00, #f64d00); /* Degradado para el estado activo */
      border-color: #e64a00;
    }
  ...
  <body>
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
      <button class="btn btn-sm btn-bd-primary-v2 py-2 dropdown-toggle d-flex align-items-center"
              id="bd-theme"
              type="button"
              aria-expanded="false"
              data-bs-toggle="dropdown"
              aria-label="Cambiar tema (automático)">
...
<section>
  <nav class="navbar navbar-expand-lg bg-body-white rounded-3">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Seller-Servitel-Servientrega</a>
