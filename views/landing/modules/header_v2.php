...
<style>
  ...
  #scrollToTopBtn {
    ...
    position: fixed;
    bottom: 20px; /* Ubicación en la parte inferior */
    left: 20px; /* Botón a la izquierda */
    opacity: 0; /* Por defecto el botón está oculto */
    transition: opacity 0.3s ease; /* Transición suave al aparecer */
  }

  /* **Mostrar el botón de subir al inicio cuando se hace scroll** */
  #scrollToTopBtn.show {
    opacity: 1; /* El botón aparece cuando se activa la clase 'show' */
  }
...
body[data-bs-theme="dark"] #logo-servitel {
  content: url('assets/imagenes/landing/logo_servitel_dark.png'); /* Ruta del logo oscuro */
  opacity: 1; /* Asegurarse de que sea completamente visible */
}

/* Logo para el tema claro (opcional, si tienes una imagen diferente para el claro) */
body[data-bs-theme="light"] #logo-servitel {
  content: url('assets/imagenes/landing/logo_servitel.png'); /* Ruta del logo claro */
  opacity: 1; /* Asegurarse de que sea completamente visible */
}
...
<a class="navbar-brand" href="#">
    <img id="logo-servitel" src="assets/imagenes/landing/logo_servitel.png" alt="Logo" style="width: 100px; height: auto; margin-right: 10px;">
</a>
        ...
        <section class="container-fluid py-5">
          <div class="container">
            <div class="row">
              <div class="col-12">
                <!-- Hero Section -->
                <div class="p-4 rounded-3 bg-body shadow-sm border">
