...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <style>
      ...
      /* Estilos para el contenedor del registro */
      .registro-container {
        background-image: url("assets/imagenes/login/fondo1.webp"); /* Ruta a la imagen del registro */
      ...
      <div class="card p-4"> 
        ...
        <form method="POST"> 
          ...
          <div class="form-floating pb-2"> 
            <input name="nombre" type="text" class="form-control" id="floatingInput" placeholder="Nombre" required autofocus>
